...
{
    public class BlockZX : UserControl
    {
        ...
        public BlockZX(string surname, string livename)
        {
            MainName = new NameSegement(surname);
            SideName = new NameSegement(livename);
            ...
            ImageBk.Source = new BitmapImage(new Uri(@"pack://application:,,,/Views/Images/zhuxian.jpg"));
        ...
        public void PrintMainText()
        {
            ...
            Canvas.SetLeft(MainNameStack, 0.9 / 2.54 * 96);
        ...
        public void PrintSideText()
        {
            ...
            if (!SideName.HasEnglish)
            {
                ...
                Canvas.SetTop(SideNameStack, 7.3 / 2.54 * 96);
